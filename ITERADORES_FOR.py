...
# Obtenemos solos nombres dela palabra clave
for pais in estudiantes:
    print(pais)
# Obtenemos lo mismo que el anterior
for keys in estudiantes.keys():
    print(keys)
# Obtenemos los valores dela palabra clave creada
...
# "continue" termina la iteraciónen curso y continua con el siguiente ciclo de iteración.
# break EJ :
for pais, numero_de_estudiantes in estudiantes.items():
    print(pais, numero_de_estudiantes)
    if pais == 'mexico':
